...
$tot=0;
$res=mysqli_query($link,"SELECT * FROM messages where rusername='$_SESSION[username]' 
&& read_message='n' ");
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li>
                                <a href="messages.php">
                                    ...
                                    <span class="badge bg-green pull-right"><?php echo $tot ?></span>
                                </a>
                            </li>
                            <li><a href="view_books.php"><i class="fa fa-desktop"></i> Books <span
